...
export const placeholderProducts: Product[] = [
  ...
  },
  {
    ...
    fullDescription:
      "Тілесна практика поєднує рух, дихання та усвідомленість у єдиний потік. Ми працюємо з напругою в тілі, відновлюємо природну рухливість та глибину подиху. Очний формат у затишному просторі в Києві дозволяє повністю зосередитися на відчуттях. Сесія включає розминку, основну практику та заключну релаксацію. Рекомендується зручний одяг та килимок.",
    durationMinutes: 90,
    price: 900,
    currency: "UAH",
  ...
  },
  {
    ...
    fullDescription:
      "Жіноча енергетична практика — це групова сесія для відновлення та наповнення енергією. Ми працюємо з циклічністю, тілесними практиками та медитацією. Очний формат у Києві створює безпечний простір для глибокої роботи. Сесія триває 2 години і включає розминку, основну практику, спільну медитацію та час для питань. Рекомендується зручний одяг, килимок та плед.",
    durationMinutes: 120,
    price: 1100,
    currency: "UAH",
  ...
  },
  {
    ...
    fullDescription:
      "Очна дихальна практика у групі в затишному просторі в Києві. Ми працюємо з різними техніками дихання: від м'яких до більш інтенсивних. Групова енергія посилює ефект практики. Сесія триває 75 хвилин і включає вступну частину, основну дихальну роботу та інтеграцію. Підходить для тих, хто вже має базовий досвід або пройшов онлайн-заняття.",
    durationMinutes: 75,
    price: 700,
    currency: "UAH",
    coverImage: "/images/placeholder-1.jpg",
